...
const UserInputForm = ({
  ...
  return (
    <div className="flex flex-col p-2 ml-2 border border-gray-300 rounded-md w-96">
      <div className="flex items-center justify-between">
        <div className={inputPairStyling}>
          ...
          <NoArrowInput
            ...
            className="w-12 p-1 text-center border rounded-md border-cyan-800"
          ></NoArrowInput>
        </div>
        <div className={inputPairStyling}>
      ...
      <div className="flex justify-center p-1">
        <button
          ...
          className="w-auto px-3 py-2 mt-2 font-bold text-cyan-700 bg-blue-50 rounded-xl hover:bg-blue-100"
        >
